...
#try with True and see the difference!!!!
scaleFeatures = False
...
#if helper.scaleFeatures: df = helper.scaleFeatures(df)
if helper.scaleFeatures: kidney_df1 = helper.scaleFeatures(kidney_df1)
...
pca.fit(kidney_df1)
T = pca.transform(kidney_df1)
#print T.shape
#print kidney_df1.shape
...
ax = helper.drawVectors(T, pca.components_, kidney_df1.columns.values, plt, scaleFeatures)
T = pd.DataFrame(T)
